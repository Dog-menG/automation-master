...
class MaxFrequency(object):
    ...
    def ui(self):
        ...
        self.Power_channel1_current_compliance.setText('0.6')
        ...
        self.Scope_source.setText('Channel3')
        ...
        self.create_summary_file.setText('Max_Min_Frequency_all_bands.csv')
    ...
    def measure(self, source1, frequency, rising_edge):
        self.myscope.measure_clear()
        self.myscope.measure(source1, frequency, rising_edge)
        time.sleep(0.5)
...
%s
        ...
        while difference < 0.01:
            ...
            self.power_on_off('ON')
            time.sleep(0.5)
            fre = float(self.measure('FREQuency', 'Channel3', 'RISing'))/10e5
